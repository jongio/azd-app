...
const (
	...
	ProjectServiceName = "azdapp.v1.ProjectService"
)
...
const (
	...
	// RPC.
	ProjectServiceGetProjectProcedure = "/azdapp.v1.ProjectService/GetProject"
)

// ProjectServiceClient is a client for the azdapp.v1.ProjectService service.
...
// NewProjectServiceClient constructs a client for the azdapp.v1.ProjectService service. By default,
...
func NewProjectServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) ProjectServiceClient {
	...
	projectServiceMethods := v1.File_azdapp_v1_project_proto.Services().ByName("ProjectService").Methods()
...
// GetProject calls azdapp.v1.ProjectService.GetProject.
...
// ProjectServiceHandler is an implementation of the azdapp.v1.ProjectService service.
...
func NewProjectServiceHandler(svc ProjectServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/azdapp.v1.ProjectService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedProjectServiceHandler) GetProject(context.Context, *connect.Request[v1.GetProjectRequest]) (*connect.Response[v1.GetProjectResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("azdapp.v1.ProjectService.GetProject is not implemented"))
}
