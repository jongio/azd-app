/**
 * ModernServiceDetailPanel - Slide-over detail panel with modern styling
 * Follows design spec: cli/dashboard/design/modern/components/detail-panel.md
 */
...
export interface ModernServiceDetailPanelProps {
  /** Service to display */
  ...
  return (
    <div className="flex justify-between items-start py-2 border-b border-slate-200 dark:border-slate-700 last:border-b-0 group">
      ...
      <div className="flex items-center gap-2 text-right">
        <span className="text-sm font-medium text-slate-900 dark:text-slate-100 break-words max-w-[250px]">
          {value}
        </span>
        {copyable && onCopy && (
          <button
    ...
    <div>
      ...
      <SectionCard title="Local Development">
        <div className="space-y-0">
          <InfoRow 
            label="Status" 
            value={<ModernStatusBadge status={effectiveStatus} />} 
          />
          {localUrl && (
            <InfoRow 
              label="URL" 
...
// =============================================================================
// ModernServiceDetailPanel Component
// =============================================================================

export function ModernServiceDetailPanel({
  service,
  isOpen,
  onClose,
  healthStatus,
  className,
}: ModernServiceDetailPanelProps) {
  ...
  return (
    <>
      ...
      >
        {/* Header */}
        <div className="flex items-start gap-3 p-5 border-b border-slate-200 dark:border-slate-700 flex-shrink-0">
          <div className={cn(
        ...
        {/* Tabs */}
        <div className="flex gap-6 px-5 border-b border-slate-200 dark:border-slate-700 flex-shrink-0">
          {tabs.map((tab) => (
            <button
              key={tab.id}
              type="button"
        ...
        {/* Actions Footer */}
        <div className="flex items-center gap-2 p-4 border-t border-slate-200 dark:border-slate-700 flex-shrink-0">
